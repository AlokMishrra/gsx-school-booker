          ...
          <Card>
            <CardContent className="p-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <Button type="submit" className="w-full zs-gradient text-white">
                  Send Message
                </Button>
              </form>
            </CardContent>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">support@zeroschool.com</p>
                      <p className="text-muted-foreground">info@zeroschool.com</p>
                    </div>
                  </div>
