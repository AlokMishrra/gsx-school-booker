-- =====================================================
-- COMPLETE ZEROSCHOOL DATABASE SCHEMA
...
DROP INDEX IF EXISTS idx_career_sessions_college;

-- Drop table
DROP TABLE IF EXISTS public.career_fair_sessions CASCADE;

-- =====================================================
-- UPDATE SCHOOLS TABLE SCHEMA
-- =====================================================

-- Add new columns to schools table if they don't exist
DO $$ 
BEGIN
    -- Add city column
...
-- Make contact_email and contact_phone nullable (optional)
ALTER TABLE public.schools ALTER COLUMN contact_email DROP NOT NULL;
ALTER TABLE public.schools ALTER COLUMN contact_phone DROP NOT NULL;
...
-- =====================================================
-- SEED DATA - Insert/Update Sample Schools
-- =====================================================
...
-- Show sample schools with new fields
